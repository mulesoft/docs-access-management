...
== Prerequisites 
Please review "OAuth 2.0 and OpenID Connect(OIDC)" section of https://learn.microsoft.com/en-us/azure/active-directory/develop/v2-protocols-oidc[Microsoft identity platform documentation]. 
...
Anypoint Platform does not support Azure AD client providers deployed in Microsoft national clouds, such as  Azure Goverment or Azure China 21Vianet. 
