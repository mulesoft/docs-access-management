...
== Microsoft Identity Platform (Azure AD) Support
...
We support 'Authorization Code', 'Client Credentials', etc. For more information on supported grant types, please go to the https://docs.microsoft.com/en-us/azure/active-directory[Microsoft identity platform documentation] and navigate to to Reference/Protocal reference/OAuth2.0 and OpenId Connect/Token grant flows.
