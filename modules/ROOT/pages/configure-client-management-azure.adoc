...
.. *Client ID*: The client ID for an existing client in your identity provider (IdP) that is capable of creating applications in Azure Active Directory.
