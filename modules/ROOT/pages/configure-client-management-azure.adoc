...
You can also create new client secrets in Anypoint Platform, but you can't remove old or expired secrets from your Microsoft account from Anypoint Platform. You must remove old and expired secrets in your Microsoft account. It is best practice to remove expired secrets promptly.
