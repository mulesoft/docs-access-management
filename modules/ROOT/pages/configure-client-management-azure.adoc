...
=== OAuth 2.0 Endpoints
Anypoint Platform supports only V2 Azure AD endpoints, i.e. Microsoft Identity Platform endpoints. Take token endpiont for example, Anypoint Platform supports https://login.microsoftonline.com/{tenantId}/oauth2/v2.0/token. 
