...
Initial secrets expiration is set to 6 months per Microsoft recommendation. You can reset client secrets via Anypoint. Note, Anypoint creates new secrets on your behalf but does not support removal of the old secrets from Microsoft account. You can always remove the old secrets in Microsoft accounts.
