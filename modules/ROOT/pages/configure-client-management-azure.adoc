...
You can also create new client secrets in Anypoint Platform, but you can't remove old or expired secrets from your Microsoft account from Anypoint Platform. You must delete old and expired client secrets in your Microsoft account. It's best practice to remove expired secrets promptly. 
