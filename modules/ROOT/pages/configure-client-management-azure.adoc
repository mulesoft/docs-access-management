...
.. *Client ID*: The client ID for an existing client in your IdP capable of introspection of all tokens from all clients. Use a client that has permissions to create applications in Azure.
