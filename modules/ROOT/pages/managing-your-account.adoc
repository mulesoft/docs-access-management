...
. Go to https://anypoint.mulesoft.com/#/signup[page].
+
...
* Company: Can be any name unless you were invited to join an existing organization, in which case the company name already set.
+
