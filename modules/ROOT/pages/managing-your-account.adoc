...
As of October 10, 2022, non-SSO users must verify their Anypoint Platform email addresses. If you have not verified your email address, an email verification request prompt appears each time you sign in.
...
. Navigate to the Anypoint Platform sign screen.
. Click the *Forgot your username or password* link.
