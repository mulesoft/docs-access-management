...
Your new password must be between 8 and 64 characters in length with at least one uppercase letter, one lowercase letter, and one number. Your password can contain only the following: +
** Upper and lower case characters
** Numbers
** Non-alphanumeric symbols

Additionally, your new password must be unique and cannot match any of your previous three passwords.
