...
If there is an existing Anypoint Platform organization that you want to join, ask the organization administrator for an invitation. When an administrator invites you to the organization, you receive an email with a link to accept the invitation. The link in one week.
...
After clicking the link in the invitation, you can choose the account to use to join the organization. The link expires in one week.
...
You can create a new account within an existing organization only if you receive an email invitation to join the organization. The link expires in one week.
...
When you attempt to create an account from an email invitation, an error appears, erroneously stating your credentials are invalid.
