...
include::partial$link-anypoint-platform-accounts.adoc[tag=profileLinkingForSSOtoLocal,leveloffset=+2]

include::partial$link-anypoint-platform-accounts.adoc[tag=profileLinkingForSSOtoSSO,leveloffset=+2]

include::partial$link-anypoint-platform-accounts.adoc[tag=profileLinkingMultiple,leveloffset=+2]
