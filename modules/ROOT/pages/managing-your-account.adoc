...
** Dashes
** Underscores
* Password - Must be at least eight characters in length with at least one uppercase and one lowercase letter. Your password can contain only the following: +
