...
** Dashes
** Underscores
* Password - Must be at least six characters in length and can contain only the following: +
...
+
Anypoint Platform creates a new master organization using the company name you entered and makes you the administrator of that organization. An Anypoint Platform account can be associated with only one organization.
...
** Dashes
** Underscores
* Password - Must be at least 6 characters in length and can contain only the following: +
** Upper and lower case characters
** Numbers
** Non-alphanumeric symbols
...
[NOTE]
If the account you want to use is already associated with another master organization, an exclamation mark is displayed next to it. This means that additional steps are needed before migrating the account to a new organization.
...
[NOTE]
If you try to sign in and Anypoint Platform says your username and password are incorrect when you have entered the correct credentials, your organization may use an xref:access-management::external-identity.adoc[external identity provider] to initiate the sign-in process. You can either use your external identity provider to sign you in, or you can xref:access-management::managing-your-account.adoc#use-CustomDomainLogin[enter your organization's domain name] prior to entering your credentials. 

[[use-CustomDomainLogin]]
== Sign in to Anypoint Platform using Single Sign-on

If your organization uses xref:access-management::external-identity.adoc[service-provider initiated Single Sign-on], you must provide your organization's domain name as part of the signin process.

. Navigate to the Anypoint Platform signin screen.
. Click *Use custom domain*.
. Enter your organization's domain name. If you do not know your organization's domain name, a member of your organization can provide the organization domain name, which is accessible in their user profile.
. Click *Continue*.
. Under *Sign in with <organization name> SSO*, click *Continue*.
...
. Go to the Anypoint Platform sign in screen.
