...
If you have not verified your email address that you use to log in to Anypoint Platform, a prompt appears to verify your email when you log in.
You can verify your email using the login prompt, or you can verify your email in your user profile.
If you are an SSO user, you cannot verify your email address through Anypoint Platform.

include::partial$include-nav-steps-to-profile.adoc[]

. Click the *Contact Info* tab.
. In the *Email* section, click *Verify Email*. +
A window appears, prompting you to enter a verification code that you received at your Anypoint Platform account's email address.
+
...
. Enter the verification code.
. Click *Confirm*. +
The email address you entered is now the email address you use to log in to Anypoint Platform.
