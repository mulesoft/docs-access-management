...
Connected apps and clients are exempt from reauthentication. Because of the reauthentication requirement, you cannot use API calls to change your email address.
