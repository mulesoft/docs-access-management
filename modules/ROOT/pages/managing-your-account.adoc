...
. Enter the following:
+
* Username - Must be at least four characters and can contain only the following: +
...
If there is an existing Anypoint Platform organization that you want to join, ask the organization administrator for an invitation. When an administrator invites you to the organization, you receive an email with a link to accept the invitation.
...
Your username must be at least four characters and contain only the following: +
** Alphanumeric characters
** Dashes
** Underscores
...
You can create a new account within an existing organization only if you receive an email invitation to join the organization.
