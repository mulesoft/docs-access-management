...
Connected apps and clients are exempt from re-authentication. Because of the re-authentication requirement, you cannot use API calls to change your email address.
