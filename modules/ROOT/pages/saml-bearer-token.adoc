...
Federated users within your organization can access Anypoint Platform APIs using the bearer token if you are using an identity provider configured to use SAML 2.0.
