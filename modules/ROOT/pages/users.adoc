...
[NOTE]
The number of permissions granted to a user might include internal permissions granted automatically by the system, which are not always visible in the UI.
