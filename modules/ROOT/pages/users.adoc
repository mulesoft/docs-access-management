...
As an organization administrator, you can modify user some sensitive user information. For enhanced security, Access Management might ask you to re-authenticate before you can modify an organization user's email address.
