...
As an administrator of your organization, you can enable, disable, or delete users, assign permissions to users, and edit a user's settings.
...
* Assign roles: Select the name of the role to grant. Check the xref:roles.adoc[roles] section for a description of the default roles within an organization and business group.
