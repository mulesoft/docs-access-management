...
As an organization administrator, you can modify user some sensitive user information. For enhanced security, Access Management might ask you to reauthenticate before you can modify an organization user's email address. Because of the reauthentication requirement, you cannot use API calls to change user email addresses.
