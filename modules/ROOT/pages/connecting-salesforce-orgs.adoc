...
* The tenant relationship is initiated by the Anypoint Platform organization administrator in Anypoint Platform and setup is completed in the Salesforce organization by the Salesforce organization administrator.  
* The tenant relationship is initiated in the Salesforce organization by the Salesforce organization administrator. 
