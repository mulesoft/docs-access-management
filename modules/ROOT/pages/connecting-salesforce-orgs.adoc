...
As a Salesforce org admin, you complete the connection between your org and the Anypoint Platform organization when the connection process is initiated in Anypoint Platform. You must have the Anypoint Platform organization key to complete the connection.
