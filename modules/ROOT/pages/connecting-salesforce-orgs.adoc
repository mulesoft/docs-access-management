...
A tenant relationship between Anypoint Platform and Salesforce orgs is established when:

* You have a Salesforce Home org with the MuleSoft Integration license.
