...
An Anypoint Platform organization administrator can initiate the process of connecting Salesforce orgs to your Anypoint Platform organization. A Salesforce org admin can initiate the connection process in the Salesforce org. For information about how to initiate the connection process in Salesforce, see LINK TO VERONICA'S DOC.
...
+
If you are not the Salesforce admin, provide the Anypoint Platform organization ID to the Salesforce admin.

The Salesforce org appears in the *Salesforce Orgs* section of the *Salesforce* page with the `Disabled` status until the connection is completed in the Salesforce org.

[complete-organization-connection]
== Complete the Organization Connection in Salesforce

As a Salesforce org admin, you complete the connection between your org and the Anypoint Platform organization.  You must have the Anypoint Platform organization ID to complete the connection.
