...
As an Anypoint Platform organization administrator, you can enable, disable, remove, and repair connections, and edit the name of Salesforce organizations.
...
You can't publish assets from Anypoint Platform to the Salesforce organization or use any of the other features associated with the connected Salesforce organization until the connection is reenabled.  
...
. Switch between *Enable* and *Disable* for the Salesforce organization to enable or disable the connection.
