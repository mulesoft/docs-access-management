...
[WARNING]
Prior to deleting a client provider, ensure that you do not have assets or environments that depend on the client provider. For example, any APIs that depend on the client provider can no longer authenticate user access.
