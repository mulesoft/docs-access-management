...
If you configure multiple client providers after you created environments, you can associate the new client providers with the environment. Review the existing client configuration before reassigning client providers to avoid any downtime with existing assets or APIs.
