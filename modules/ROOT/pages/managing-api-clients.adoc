...
You can make them available to business group administrators to xref:environments.adoc#add-an-idp-to-an-existing-environment[associate the IdPs with different environments] depending on your organization's policies. 
