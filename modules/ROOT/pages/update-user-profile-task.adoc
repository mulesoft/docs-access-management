...
To update user profile information from your configured IdP, sign into Anypoint Platform through the IdP. When you sign in, your user profile is automatically updated with the information from the IdP.
