...
You must have the Salesforce organization tenant key to connect before you can connect to a Salesforce organization. If you don't have the Salesforce organization tenant key, contact the Salesforce admin for the organization to connect. 
