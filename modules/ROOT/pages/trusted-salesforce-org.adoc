...
If you want to permanently delete the connection between your Anypoint Platform organization and your Salesforce organization using the Salesforce interface. After you delete the connection, a user with the appropriate permissions in both your Anypoint Platform and Salesforce organizations must recreate the connection.
