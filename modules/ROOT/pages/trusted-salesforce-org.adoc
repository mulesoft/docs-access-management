...
Enable cross-platform features between your Anypoint Platform organization and a trusted Salesforce organization (tenant) by establishing a connection between them. An Anypoint Platform organizaation administrator can establish relationships with multiple Salesforce orgs, but a Salesforce organization can connect to only one Anypoint Platform organization.
