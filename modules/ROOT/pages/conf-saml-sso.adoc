...
Use SAML 2.0 with your external identity provider (IdP) to authenticate users and enable Single Sign-on (SSO) to Anypoint Platform. Provide issuer, sign‑on/sign‑off URLs, certificate, and audience, then save and test the connection.
