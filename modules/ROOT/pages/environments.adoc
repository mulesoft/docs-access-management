...
If your organization administrator provides multiple identity providers, or IdPs, for your master organization, you can add them to existing environments as client providers.
