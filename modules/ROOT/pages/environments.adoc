...
You can remove a client provider from an environment at any time. However, this may affect your APIs and other assets. For more information on how the removal of client providers affects APIs, see (topic on that).
