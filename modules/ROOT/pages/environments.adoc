...
. Optionally, select at least one xref:managing-api-clients.adoc[client provider] for your environment. If you do not select a client provider, Anypoint is the default client provider.
...
If your organization administrator provides multiple xref:managing-api-clients.adoc[client providers] for your organization, you can add them to existing environments. If you did not associate a client provider with the environment when you created it, the default client provider is the Anypoint client provider.
...
. In the menu on the left, click *Environments*.
. Click the name of the environment.
. Click the *x* next to the name of the client provider that you want to remove.
. Click *Update*.
