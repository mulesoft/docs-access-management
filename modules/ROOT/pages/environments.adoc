...
* If an existing name is used to create a new environment, the newly created evironment name will have a "-<n>" appended to it, where the <n> is an incremental number 
