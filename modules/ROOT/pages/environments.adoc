...
If your organization administrator provides multiple xref:managing-api-clients.adoc[identity providers], or IdPs, for your organization, you can add them to existing environments as client providers.
