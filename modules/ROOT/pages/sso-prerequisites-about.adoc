...
* There is no sync between external identity and Anypoint on user deletion. If a user is deleted/removed from the customer's IdP then Anypoint will not know about this change and the user does not get deleted in Anypoint automatically. 
