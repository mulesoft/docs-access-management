...
In the *Network* tab, the `receive-id` line indicates that you attempted to log in to Anypoint Platform using your SSO.
If the login is successful, you can expand `receive-id` and access form data that contains your SAML response element.  
