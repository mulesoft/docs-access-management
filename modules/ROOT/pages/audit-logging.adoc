...
Audit logs have a default retention period of six years. Download your logs periodically if you want to maintain your log files for longer than six years. To check the audit log retention period for your organization, use the (link to audit logging API).
