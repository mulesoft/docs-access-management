...
The audit log UI is embedded in Access Management. If you are not an *Organization Administrator*, but you have the *Audit Log Viewer* role, you can see only the audit log UI under Access Management.
...
* The MuleSoft procurement staff changes entitlements for your organization as a result of license grants or something similar
