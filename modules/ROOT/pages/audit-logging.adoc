...
You can access the
https://dev-portal.mulesoft.com/apis/audit-log-query.html[Audit Log REST API] from the Audit Log Query API.
...
The https://dev-portal.mulesoft.com/apis/audit-log-query.html[Audit Log Query API] uses pagination with cursors, so you can initiate query loops using cursors. Setting the `cursorPagination` query parameter to `true` enables you to use cursor paging.
