...
* **API Creators**: Enables users to create and manage an API in Anypoint Platform. Members of the API Creator role can add new APIs to the platform on the API administration page. This role does not grant privileges for Runtime Manager. This role has the following permission scopes:
+
** Create/Import an API

* **API Versions Owner**: Enables users to manage, delete, and deprecate any API in the organization. They can edit the portal of any API in the organization. However, this role does not enable a user to create a new version of an existing API. This role has the following permission scopes:
+
...
* **Audit Log Viewers**: Enables users to access to the UI for the Audit Log under Access Management. This role has the following permission scopes:
+
...
* **Exchange Administrators**: Enables users to manage Exchange Portals, including customization, manage assets, manage reviews. This role has the following permission scopes:
+
** Create content
** Manage assets
...
* **Exchange Viewers**: Enables users to view and consume Exchange assets. This role has the following permission scopes:
+
