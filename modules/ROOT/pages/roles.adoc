...
[WARNING]
The Roles feature in Access Management was deprecated in December 2019. Using the xref:teams.adoc[Teams] feature, users are now assigned permissions instead of roles. For more information, see the xref:access-management::roles-to-teams-transition.adoc[Roles to Teams Transition] documentation or contact your Customer Success Manager to determine how you can migrate to the Teams feature in Access Management.
...
. Select the *Access Management* option from the main page, or click the _menu_ button in the top-left corner.
+
image::anypoint-platform-nav-menu.png[]
. In the Access Management page, click *Roles*.
+
