...
. Click the name of the custom role you want to add permission scopes to.
...
. Click the name of the custom role you want to grant API access to.
+
...
. Click the role whose limits you want to view.
