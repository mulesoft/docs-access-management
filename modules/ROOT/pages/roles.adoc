...
[NOTE]
Roles are deprecated in favor of the xref:teams.adoc[Teams] feature, but you can still manage roles using business groups. You grant most roles as permissions instead.
