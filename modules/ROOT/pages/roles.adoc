...
. Click the name of the custom role to add users to.
...
. Click the name of the custom role to add permission scopes to.
...
. Click the name of the custom role you want to add users to.
...
. Click the name of the custom role to grant API access to.
+
...
. Select the team to merge the role members with.
. Click *Merge with Team*.
+
...
. Click the role with the limits you want to view.
