...
.. *Disable account creation*: Accounts must join the organization using an external identity provider. Existing accounts are unaffected and can continue to log in using their credentials.
. Click *Save Changes*.
