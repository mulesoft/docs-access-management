= Managing External Identity Providers in Anypoint Platform

Configure up to 25 external identity providers (IdPs) in Anypoint Platform to enable single sign-on (SSO) for your organization. Anypoint Platform supports SAML 2.0 and OpenID Connect (OIDC) configurations for SSO providers.
