...
To prevent service disruptions, configure CI/CD pipelines using service accounts to programmatically call Anypoint Platform to use connected apps when configuring xref:multi-factor-authentication.adoc[multi-factor authentication].
