...
* You need the Organization Administrator permission at the business group level you want to create connected apps in and specify access scopes for. For more information, see xref:permissions-by-product.adoc#access-management[].
