...
* Acme
This team is your organization and parent team, and every user in your organization is a member. All Acme users are responsible for creating new projects in Anypoint Design Center and are able to view assets in Anypoint Exchange. As members of the Acme organization, all Acme users have the following permissions:
** Design Center Developer
** Exchange Viewer
* Engineering
This team is the first child team of the Acme team. This team includes all of Acme’s engineers, but it excludes Acme’s other members. The members of the Engineering team can deploy code to preproduction environments such as Dev and QA. The Engineering team inherits permissions from the Acme team, but it also has additional permissions afforded to its members. As members of the Engineering team, all engineers have the following permissions:
** (insert deployment permission here)
** Design Center Developer
** Exchange Viewer
* DevOps
...
** (deployment permission from Engineering)
** Design Center Developer
** Exchange Viewer
* Identity
This team is one of two child teams under the Engineering team. The Identity team has access to its designated business group where it manages projects, assets, and other materials to facilitate collaboration within the business group. As members of the Identity team, all Identity users have the following permissions:
** (specific identity permission)
** (deployment permission from Engineering)
** Design Center Developer
** Exchange Viewer
...
If you have the Administrator permission or are a team maintainer, you can create child teams within your team. The child team inherits permissions from its parent team, but you configure additional, specific permissions to it.
...
For more information about inviting a user to an existing team via email, see xref:<topic that talks about email invites>.adoc[insert title of that section here].
