...
Note, the dynamically registrated application at the identity provider has only default settings. If you want to configure additional functionalities e.g. groups mapping, you will be responsible to update the settings at the provider side. 
