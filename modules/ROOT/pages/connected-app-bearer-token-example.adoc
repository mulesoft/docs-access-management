...
. Select the *Business Groups* the app has permission to access the assigned scopes and click *Next*.
...
. In the *Owned Apps* section, click *Copy Id* for the app to get the bearer token for and save the app's client ID in a secure location.
