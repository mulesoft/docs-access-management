= Getting the Bearer Token for a Connected App in Anypoint Platform

Use this example as a reference for creating a connected app with client credentials, adding Runtime Manager scopes, and retrieving a bearer token to invoke Anypoint Platform APIs. The example includes deploying the app to CloudHub and using the Access Management API to obtain the token.
...
----
+
Now that you have the bearer token, you can use the connected app to invoke Anypoint Platform APIs. For more examples, see the https://dev-portal.mulesoft.com/apis/access-management.html[Access Management API documentation].
