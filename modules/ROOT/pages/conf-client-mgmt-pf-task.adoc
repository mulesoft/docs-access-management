= Configuring Client Management with PingFederate
:page-notice-banner-message: Anypoint Platform support for PingFederate versions 6 through 8 ends on June 30, 2026. Use OpenID Connect or Microsoft Entra ID instead.
...
== Manage a PingFederate Client Provider
...
. Click the name of the PingFederate client to edit. 
...
* https://docs.pingidentity.com/pingfederate/latest/developers_reference_guide/pf_oauth_20_endpoints.html[PingFederate OAuth 2.0 Endpoints]
* https://docs.pingidentity.com/pingfederate/latest/developers_reference_guide/pf_web_service_interface_api.html[PingFederate Web Service Interfaces and APIs]
