= Anypoint Platform Connected Apps for End Users
...
[NOTE]
The organization administrator must set up and integrate the connected app before you can grant access to it. See xref:connected-apps-developers.adoc[].

To grant access to a connected app:

. In the *Authorize App* dialog, click *Grant Access*.
+
