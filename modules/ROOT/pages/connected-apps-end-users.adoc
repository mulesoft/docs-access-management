...
End users can delegate API access and sign in to third-party applications using their Anypoint Platform credentials. They can also view connected apps created in their root organization or business groups.
...
End users can manage third-party apps that they have authorized in their profile settings. They can view authorized apps in their profiles by clicking on their profile icon and selecting *Profile*. The following screenshot illustrates how a user’s profile page shows authorized connected apps:
