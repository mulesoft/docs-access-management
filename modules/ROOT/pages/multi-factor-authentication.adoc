...
For enhanced security, you can require all users in your organization to use multi-factor authentication. Users can configure their authentication method when they log in to Anypoint Platform after you initially enable multi-factor authentication.
