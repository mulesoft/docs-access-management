...
When you disable the multi-factor authentication requirement, users are no longer required to use multi-factor authentication to log in to Anypoint Platform. Additionally, new users who log in do are not prompted to configure multi-factor authentication.
