...
After multi-factor authentication is enabled, users must verify their Anypoint Platform credentials using at least one of four authentication methods.
...
. Click *Save*. +
All nonexempt users in your organization are now required to configure a multi-factor authentication method when they log in to Anypoint Platform. +
...
[NOTE]
--
If your organization has disabled its multifactor authentication requirement, you can remove all authentication methods. However, for enhanced security, it is best to use at least one verification method.
--
...
. Click the pencil icon next to the authentication method that you want to rename.
...
. Click *Yes*
. Click *Done*. +
If your organization requires multi-factor authentication and you have removed all authentication methods, you must configure at least one authentication method before you save your changes.

== Disable Multi-factor Authentication Requirement for All User Accounts

When you disable the multi-factor authentication requirement, existing users no longer use it to log in to Anypoint Platform and new users log in without being prompted to configure it.
...
You can reset multi-factor authentication for individual users if a device is compromised or lost.
