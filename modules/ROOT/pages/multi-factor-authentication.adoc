...
If you use multi-factor authentication, because your organization requires it or you've turned it on for yourself, you can modify the verification methods that you use to log in. You must register at least one method to use MFA.
