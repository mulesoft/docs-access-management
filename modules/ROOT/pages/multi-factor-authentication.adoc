...
* An an organization administrator, you have the option to exempt specific user accounts from the multi-factor authentication requirement, in order to allow existing integrations to continue operating without interruption. 
