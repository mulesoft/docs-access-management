...
For SSO users, set up MFA through the identity provider (IdP). Since MFA is managed by the IdP, multi-factor authentication is shown as `n/a` in user Settings for SSO users.
