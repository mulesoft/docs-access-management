...
////
[NOTE]
Beginning February 1, 2022, multi-factor authentication (MFA) or single sign-on (SSO) must be enabled for all of your Salesforce products. To learn more about this requirement, see the https://help.salesforce.com/apex/HTViewSolution?urlname=Salesforce-Multi-Factor-Authentication-FAQ[Salesforce Multi-Factor Authentication FAQ].
////
