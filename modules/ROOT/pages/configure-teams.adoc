...
If you are the Organization Administrator for a business group, you can create child teams in the business group you have the Organization Administrator permission in and become the maintainer for that team.

When you're a team maintainer, you can create child teams for the team you are a maintainer for.  
...
After you create child teams, you can invite new users directly to the appropriate team using email invitations or using the Teams feature interface.
...
To modify permissions for all teams in the organization, you must have the Organization Administrator permission in the root organization.
...
If you have the Organization Administrator permission in the root organization, you can configure permissions for the root team and all its child teams.
