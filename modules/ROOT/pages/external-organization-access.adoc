...
== Manage a Tenant Relationship to a Trusted Salesforce Organization 

NOTE: This feature is currently available only for select Anypoint Platform and Salesforce customers.

Salesforce organizations can establish a tenant relationship with their Anypoint Platform organizations. After this relationship is established, an Anypoint Platform user with the Organization Administrator permission can enable and disable this relationship in the *Access Management* user interface in Anypoint Platform. For more information on initiating a relationship with Salesforce, see https://help.salesforce.com/s/articleView?id=sf.external_services_manage_your_mulesoft_anypoint_platform_connection.htm&type=5[Manage Your MuleSoft Anypoint Platform Connection] in the Salesforce documentation.

When you enable this connection with your Salesforce organization, the trusted Salesforce organization can publish assets from your Anypoint Platform organization. 
...
A list of Salesforce organizations that have requested tenancy appears, showing the name, organization ID, domain, and status of the relationship connection.
+
