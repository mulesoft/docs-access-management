...
When you enable this connection with your Salesforce organization, you can publish assets from your Anypoint Platform organization to the trusted Salesforce organization. 
...
A list of Salesforce organizations appears, showing the name, organization ID, domain, and status of the relationship connection.
+
