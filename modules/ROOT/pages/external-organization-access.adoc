...
When an external organization elects to share resources with your organization, the external organization does not receive any information about your organization. When resources are shared, they are shared between organizations and not individual users. The user permissions required to use shared resources cannot be modified by external organizations.
...
. Enter the unique domain name of the organization whose resources you want to access. If you do not know the domain name, contact the organization administrator for that organization.
. Click *Add*.
