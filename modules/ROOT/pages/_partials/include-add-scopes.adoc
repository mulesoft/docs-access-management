...
. Click *Add Scopes*.
+
Scopes are roles with associated permissions, which determine which actions the app can perform within a business group and environment. For more information, see <<endpoint-scopes>>.
