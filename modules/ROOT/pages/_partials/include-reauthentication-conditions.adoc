...
Each time you log in or re-authenticate, the timer resets. If less than 30 minutes has elapsed since you logged in, Access Management does not prompt for your password again.
