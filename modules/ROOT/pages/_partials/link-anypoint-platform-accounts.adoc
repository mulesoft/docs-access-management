...
Organization administrators can remove a linked profile from a user account by making a `DELETE` call to `/accounts/api/organizations/:orgId/users/:userId/identityProviderProfiles`. For details, see the https://dev-portal.mulesoft.com/apis/access-management.html[Access Management API documentation]. 
