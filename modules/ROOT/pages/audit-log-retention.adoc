...
. Click *Save Changes*. +
A warning appears, confirming your new retention period and date effective.
+
. Click *Confirm*. +
The new audit log retention period takes effect on the date you specified.

== See Also

* xref:audit-logging.adoc[]
* https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/audit-log-query-api/minor/1.0/console/method/%23335/[Audit Logging API^]
