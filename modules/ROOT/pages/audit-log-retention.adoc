...
xref:audit-logging.adoc[Audit logs] have a default retention period of six years. Users who have the Audit Log Config Manager permission can configure the retention period for the audit logs in their organization.
