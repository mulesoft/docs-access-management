...
The Roles feature was deprecated in December 2019. You must transition your legacy roles to the new xref:teams.adoc[Teams] feature to ensure your users have correct permissions.
...
* xref:teams.adoc[Manage User Access Using Teams]
