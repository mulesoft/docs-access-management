...
* Governance Manager - Admin
* Governance Manager - Viewer
* Governance Manager Contributor
...
Depending on your organization, you might see one of the following sets of permissions available for Partner Manager.
