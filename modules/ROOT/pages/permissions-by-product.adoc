...
Mule Developer Generative AI User:: Enables a user to use natural language prompts to develop and generate flows using the Einstein for Anypoint Code Builder Generative Flows feature. This permission is displayed only if the organization administrator enables the *Gen AI* feature for Anypoint Code Builder. 
