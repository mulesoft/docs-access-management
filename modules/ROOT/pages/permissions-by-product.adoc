...
Audit Log Config Manager:: Enables users to configure the retention period for audit logs across their organizations. Apply this permission at the root organization level. This permission appears only if the organization has the modern UI enabled in Access Management.
