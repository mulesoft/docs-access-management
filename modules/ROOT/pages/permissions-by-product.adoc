...
Exchange Creator:: Enables a user to create new assets within a business group’s catalog, but cannot modify assets or asset versions created by other users in the business group. 
+
