...
include::partial$include-root-org-permissions-note.adoc[]
|Mule Developer Generative AI User | Use natural language prompts to develop and generate flows using the Einstein for Anypoint Code Builder Generative Flows feature. |include::partial$include-root-org-permissions-note.adoc[]
|===
