...
|Destination subscriber for given environment | Consume messages from a destination and delete messages from a destination.|
| Destination publisher for given environment| Send messages to a destination and update message TTL on a destination.|
...
|View Host, Partners and Message Flows|Have view-only access to the host, partner, and message flow configurations.| This user cannot view transaction activity.
...
|RPA Automations Designer | RPA developer, citizen technologist, or knowledge source (such as a business analyst or process owner) to do the following in RPA Manager:
...
| RPA Automations Contributor | RPA developer, citizen technologist, or knowledge source (such as a business analyst or process owner) to do the following:
...
|RPA Automations Manager |RPA developer, citizen technologist, or knowledge source (such as a business analyst or process owner) to do the following:
...
| RPA Bots Manager |Do the following in RPA Manager:
...
Do the following in RPA Manager:
...
| RPA Evaluations Contributor | Do the following in RPA Manager:
...
| RPA Evaluations Manager | Do the following in RPA Manager:
...
* Process Evaluation Open
| RPA Operations Viewer | Eo the following in RPA Manager:
...
| RPA Operations Manager | Do the following in RPA Manager:
...
| RPA Performance Analyzer |Do the following in RPA Manager:
...
| RPA Project Manager | Be assigned as a project manager of automation projects in RPA Manager. For a user to function as a project manager, the user must also have one of the following permissions:

* RPA Automations Designer
* RPA Automations Contributor
* RPA Automations Manager
* RPA Administrator
| The RPA Project Manager permission contains the deprecated RPA Project Management permissions.
|===
