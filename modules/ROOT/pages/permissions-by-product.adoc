...
* Process Recording
====
|RPA Automations Manager |RPA developer, citizen technologist, or knowledge source (such as a business analyst or process owner) to:
...
====
| RPA Bots Manager |In RPA Manager:
...
====
| RPA Evaluations Contributor | In RPA Manager:
...
* Process Evaluation Open
====
| RPA Evaluations Manager | In RPA Manager:
...
* Robot State and Operation Open
====
| RPA Operations Manager | In RPA Manager:
...
====
| RPA Performance Analyzer |In RPA Manager:
