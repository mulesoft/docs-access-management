...
Mule Developer Generative AI User:: Enables a user to use natural language prompts to develop and generate flows using the Einstein for Anypoint Code Builder Generative Flows feature.  
...
CloudHub Network Administrator:: Enables a user to manage CloudHub and CloudHub 2.0 network resources.

CloudHub Network Viewer:: Enables a user to view CloudHub and CloudHub 2.0 network resources.
...
Manage Tokenization Services:: Enables a user to view, create, edit, and delete tokenization resources.
