...
include::partial$include-root-org-permissions-note.adoc[]
|Mule Developer Generative AI User | Use natural language prompts to develop and generate flows using Agentforce for Anypoint Code Builder Generative Flows. |include::partial$include-root-org-permissions-note.adoc[]
|===
