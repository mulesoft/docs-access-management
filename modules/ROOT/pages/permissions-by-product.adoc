...
Audit Log Config Manager:: Enables a user to configure the retention period for audit logs over their organization. Note that you must apply this permission at the root organization level.
