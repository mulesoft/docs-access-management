...
Organizations that use the legacy user interface in Access Management can now upgrade to the modern user interface. The modern user interface has feature parity with the legacy UI but provides additional features, better accessibility, and a polished and intuitive interface. 
