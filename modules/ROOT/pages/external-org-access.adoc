...
This enables your organization to maintain an independent Anypoint Platform organization without keeping resources isolated from external organizations that have partnerships or shared projects. For example, when you add an external organization to your external access list, that organization can share resources with your organization through Anypoint Exchange. 
