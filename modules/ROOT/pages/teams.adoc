...
[[opt-in-to-teams]]
== Migrate to Access Management's Modern UI

If your organization uses the Roles feature (deprecated) as its primary means of managing permissions, your organization is using the legacy UI in Access Management. Migrate your organization to Access Management's modern UI, which enables you to use the Teams feature to manage permissions:

include::partial$include-nav-steps-no-permissions.adoc[]

. In the Access Management navigation menu, click *Try New Features*. +
If you do not see the *Try New Features* interface, your organization already uses the modern UI.
