...
If your organization uses the Roles feature (deprecated) as its primary means of managing permissions, your organization uses the legacy UI in Access Management. The following steps enable you to migrate your organization to Access Management's modern UI, which enables you to use the Teams feature to manage permissions:
