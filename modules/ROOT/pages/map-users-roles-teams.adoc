...
If your organization uses single sign-on but also requires you to obtain permissions from multiple groups, you can configure an attribute that contains all of the groups from which you want to obtain individual access permission. In many cases, you can create an array of groups.
