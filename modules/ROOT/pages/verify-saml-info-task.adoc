...
During verification of SAML information, if you determine that information needs to be changed, sign into the MuleSoft Support Portal and submit a request.
