= Verifying SAML Information
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

Confirm that your SAML 2.0 single sign-on (SSO) configuration within Anypoint Platform contains the correct information provided by your identity provider (IdP). Check key settings like the Group Attribute Name by navigating to the SAML 2.0 section in Access Management. If discrepancies are found that require modification by MuleSoft, contact support.
