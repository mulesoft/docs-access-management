...
During verification of SAML information, if you determine that information requires a change, log in to the MuleSoft Support Portal and submit a request.
