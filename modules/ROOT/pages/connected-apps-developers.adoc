...
Because the app has to collect the user’s credentials and the `password` grant type's limitation in using mechanisms for things like multi-factor authentication, using this grant type isn't recommended.
...
xref:https://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a[…]management-api/minor/1.0/pages/Connected%20App%20Examples/[Access Management API - Connected App Examples]
