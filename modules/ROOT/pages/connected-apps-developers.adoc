...
If you add new scopes to your app at a later date, you will not be able to request those scopes from users until the admin re-approves your app.
Existing authorizations and new authorizations using the already-whitelisted set of scopes will continue to work.
For more info, see xref:connected-apps-org-admin.adoc#Application-Whitelist[connected apps for admins].
