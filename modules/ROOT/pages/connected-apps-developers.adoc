...
[NOTE]
Apps that use `client_credentials` grant type always have the `profile` scope assigned to them. The data returned by queries using the scope correspond to the user who created the connected app. 
