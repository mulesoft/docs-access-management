...
Before configuring OpenID Connect or SAML 2.0, select an OpenID Connect-compliant provider, such OpenAM or Okta. If you are not using OpenID Connect, select any SAML 2.0-compliant provider.
