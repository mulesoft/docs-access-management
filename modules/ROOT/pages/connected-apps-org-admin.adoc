...
When you create a connected app to act on its own behalf using client credentials, you can choose which master organization or business groups to enable it in after you choose scopes.
