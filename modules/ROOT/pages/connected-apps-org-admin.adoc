...
Organization administrators are the only users who can view and manage connected apps in Access Management.
...
* *Disabled*
  ...
  Use of connected apps is disabled for the entire organization. Owned apps can be created and used by other organizations.

Organization Administrators can also manage which apps are authorized to access users' data.

=== Whitelist applications

Using Connected Apps, Organization Administrators can also view which users have granted access to different apps in addition to the access scope.
Organization Administrators can revoke or reinstate access to the app at any time.

When an Organization Administrator revokes access, the app's OAuth access token is revoked, and the app can no longer access user data.
If the Organization Administrator decides to grant access back to the app, they can whitelist the app.

Organization Administrators can manage apps in the *Authorizations* tab in Connected Apps.
