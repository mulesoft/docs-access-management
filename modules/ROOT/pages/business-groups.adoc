...
+
* If you use this feature on a business group and then create a child business group under the original, you are automatically given the Organization Administrator permission for the new child business group.
