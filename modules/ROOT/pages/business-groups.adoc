...
==== View User Access and Permissions

. In *Access Overview*, select the business group or environment from the dropdown to view a list of users with access to the selected business group or environment.
...
==== View Team Access and Permissions

. In *Access Overview*, select *Teams* from the dropdown to see a list of teams that have access to the current business group.
. Optionally, select an environment from the dropdown to view a list of teams with access to the selected environment.
. To see teams that have specific permissions assigned, select the permission from the dropdown. 
+
Permissions that are granted directly to users outside of the Teams feature aren't shown in the returned list. 
