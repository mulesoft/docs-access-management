...
[NOTE]
--
a. When a Business Group or a Child Business Group is created, it is advised to Logout and Login again to see the newly created groups in the top-right corner Menu.
b. When you log in to Anypoint Platform, you return to the business group where you were last active when you logged out of Anypoint Platform.
--
