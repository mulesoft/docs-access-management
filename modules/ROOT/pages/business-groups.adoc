...
== View User and Team Access to a Business Group
...
. To see a list of users with specific permissions assigned to them, select a permission from the dropdown. 
+
A list of users that have the selected permission is shown. 
. To see a list of teams 
. Use the dropdowns to specify:
* *Users*
+
The permissions shown are permissions that are directly assigned to the user. 
* *Teams*
