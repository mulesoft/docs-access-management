...
The Teams feature enables you to create groups of users and then assign the members of those groups certain permissions. As an Organization Administrator, you can create and modify teams and assign permissions according to organizational structure.
