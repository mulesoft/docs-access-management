...
If your IdP supports multiple keys, you can rotate keys to seamlessly retire keys that have been in use for an extended period of time.
Anypoint Platform can generate a key to use with your IdP, or you can provide a public and private key pair.
You can store up to 3 keys, and you can set a primary key or revoke a key at any time.
To prevent service disruptions, ensure your IdP has an active key when you change your key configurations.
...
Because you can use up to 3 keys with Anypoint Platform, you can designate a _primary key_ to be used for signature verification between the IdP and Anypoint Platform.
...
. Next to a SAML 2.0 IdP, click *Edit*.
. Click the *Anypoint Keys* tab.
. Next to the key that you want to revoke, click *...* and select *Use as primary key...*.
. Click *Apply*.

=== Revoke a Key

When a key is compromised, you can revoke it and use another key.
