...
. Click *Save*.
+
. Sign out of Anypoint Platform, navigate to the Sign On Url you entered in the *Identity Management SAML 2.0* form, then sign in via your identity provider to test the configuration.
