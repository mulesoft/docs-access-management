...
+
If enabled, we require that the SAML assertions sent from the IdP is encrypted following the guidelines mentioned in the xref:sso-prerequisites-about.adoc[Prerequisites].
+
. Click *Save*.
+
