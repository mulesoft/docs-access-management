...
To fetch and validate metadata for an existing client provider, save that client provider again, and the list of supported grant types updates automatically.
