...
* Users per root organization or business group: 10000
* Environments per root organization or business group: 150
* API Manager clients per root organization: 10000
* Runtime clients per root organization or business group: 10000
* External access relations per root organization or business group: 20
...
* Connected apps per root organization or business group: 2000
