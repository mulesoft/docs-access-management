...
[NOTE]
====
To ensure the stability and support of your client management integration, avoid making manual edits to the application directly within the Azure portal.
...
Client secrets are set to expire six months from the date of creation per Microsoft's security recommendations. You can customize the expiration date when <<config-client-provider,configuring the client provider>>.
