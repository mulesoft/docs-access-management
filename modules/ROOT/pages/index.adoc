...
* xref:managing-permissions.adoc[Assign permissions to individual users] or set up hierarchical user management by using the xref:teams.adoc[Teams] feature to manage access to assets and areas of your organization.
...
* Develop and configure xref:connected-apps-overview.adoc[connected apps] to delegate access to Anypoint Platform.
* Grant xref:external-organization-access.adoc[external organizations] access to your resources to enable cross-organization collaboration.
