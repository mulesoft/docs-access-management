...
NOTE: You must manually register the domain for Exchange assets and public portals created before 2024.
...
NOTE: Non-authenticated requests from public portals in Exchange or via shareable links in the Mocking Service are automatically registered. 