...
When the Salesforce administrator enables Einstein for the connected Anypoint Platform organization, Einstein requests are routed through the connected Salesforce organization. Tracking and billing are handled in the Salesforce organization. 
...
. Click *Close*.
+
After Einstein is enabled in the Salesforce organization, Anypoint Platform shows that it's *Enabled in Salesforce* for the connected Salesforce organization.

[[enable-einstein-anypoint]]
== Enable Einstein for Your Anypoint Platform Organization

When Einstein is enabled in Anypoint Platform through a connected Saleforce organization, any Anypoint Platform feature running in that organization can use Einstein. The Salesforce administrator can't specify which features are enabled for Einstein, for example, IDP can use Einstein but Anypoint Code Builder can't. 
