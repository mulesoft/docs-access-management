...
* The Organization Administrator permission and role.
...
When Einstein is enabled in Anypoint Platform, any Anypoint Platform feature running in that organization is able to use Einstein. The Salesforce administrator isn't able to specify that Einstein can only be used for particular features, for example, IDP can use Einstein but Anypoint Code Builder can't. 
